...
$(window).load(function() {
    ...
    MESSAGES.push({
        delay: 1200,
        text: 'Tal vez escribiste mal la URL.'
    });
    MESSAGES.push({
        delay: 2200,
        text: 'O tal vez ya borramos este contenido...'
    });
    MESSAGES.push({
        delay: 3600,
        text: 'Y bueno, no tenemos nada para mostrar aca!!...'
    });
    MESSAGES.push({
        delay: 5200,
        text: 'Te dejo 2 opciones para continuar, Gracias!!'
    });
    $container = $('#container');
    $message = $('#message');
    $animate = $('#animate');
